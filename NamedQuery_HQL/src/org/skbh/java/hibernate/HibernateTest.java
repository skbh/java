...
public class HibernateTest {
	...
	public static void main(String[] args) {
		...
		Query query = session.createSQLQuery("SELECT * FROM userdetail").addEntity(UserDetail.class);
		 ...
		 * "userName10")).add(Restrictions.gt("userId", 5));
		 * criteria.add(Restrictions.like("userName",
		 * "%userName1%")).add(Restrictions.between("userId", 1, 20));
